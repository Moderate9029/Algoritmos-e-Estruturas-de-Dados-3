/************************************************************************************************
    ...
    @author Felipe Pereira Sarmento         Criado 24/03/2022 - Última Atualização 28/04/2022
*************************************************************************************************/
public class TADFila{
    ...
    public TADFila(int tamanho){
        ...
        System.out.println("Estou no CONSTRUTOR com parametro!!!");
    }
    ...
    public TADFila(){
        ...
        inicio = -1;
        dados = new TPessoa[capacidade];
        System.out.println("Estou no CONSTRUTOR sem parametro!!!");
    }
